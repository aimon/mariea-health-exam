...
from .serializers import ProviderSerializer, PaymentTermSerializer, PlanSerializer, PlanTermSerializer, UserSerializer, CartSerializer, CartItemSerializer
...
# Payment Term
class PaymentTermListCreate(generics.ListCreateAPIView):
